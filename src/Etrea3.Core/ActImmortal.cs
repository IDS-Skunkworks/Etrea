...
namespace Etrea3.Core
{
    public static class ActImmortal
    {
        ...
        public static void SnoopConnection(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void MutePlayer(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void UnMutePlayer(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void FreezePlayer(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ThawPlayer(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ZoneReset(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ReleaseOLCLock(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void CheckMobMemory(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void GenerateAPIKey(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void AddNodeToRoom(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ShowShopInfo(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void TickShop(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ShutDownGame(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void MessageOfTheDay(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ShowBackupInfo(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void SetDonationRoom(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void LogAction(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void AddPlayerLanguage(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void RemovePlayerLanguage(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
                Game.LogMessage($"WARN: Player {session.Player.Name} attempted to modify the languages of another player but they are not Immortal", LogLevel.Warning);
        ...
        public static void GiveRecipe(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void RemoveRecipe(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void GiveSpell(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ShowImmInventory(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ShowImmCharSheet(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void RemoveSpell(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void RemoveSkill(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void GiveSkill(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ImmHeal(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ChangeExp(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void VoiceOfGod(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void FindAsset(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void SetActorAttribute(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void TransferTarget(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ForceActor(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void CreateAsset(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void SummonTarget(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void Destroy(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void TeleportToTarget(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void Slay(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void Purge(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        public static void ListAssets(Session session, ref string arg)
        {
            if (!session.Player.IsImmortal)
            {
        ...
        private static void ListHelpArticles(Session session, string criteria)
        {
            StringBuilder sb = new StringBuilder();
            if (string.IsNullOrEmpty(criteria))
            {
                var articles = HelpManager.Instance.GetArticle();
                sb.AppendLine($"  %BYT%{new string('=', 77)}%PT%");
            ...
            {
                var article = HelpManager.Instance.GetArticle(criteria);
                if (article == null)
                {
                    session.Send($"%BRT%No matching Help Article could be found.%PT%{Constants.NewLine}");
                    return;
                }
                sb.AppendLine($"  %BYT%{new string('=', 77)}%PT%");
                sb.AppendLine($"%BYT%||%PT% Title: {article.Title}");
                sb.AppendLine($"%BYT%||%PT% Imm Only: {article.ImmOnly}");
                sb.AppendLine($"%BYT%||%PT% Article Text:");
                foreach (var ln in article.ArticleText.Split(new[] { Constants.NewLine }, StringSplitOptions.None ))
                {
                    sb.AppendLine($"%BYT%||%PT% {ln}");
                }
                sb.AppendLine($"  %BYT%{new string('=', 77)}%PT%");
                session.Send(sb.ToString());
            }
